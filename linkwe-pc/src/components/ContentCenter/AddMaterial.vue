      ...
      <el-col :span="!showPhone ? 24 : 16" :class="!showPhone ? 'mt10' : 'boxClass'" class="left radius">
        ...
        <div class="g-card">
          ...
          <el-form ref="talkform" :model="talkForm" :rules="talkRules" label-width="80px">
            ...
            <el-form-item label="使用员工" required v-if="iswelcom && tplType === '2'" :error="userInfo">
              ...
              <div>
                <el-button type="primary" size="mini" plain @click="onSelectUser" :error="userInfo">选择员工</el-button>
              </div>
              <div class="sub-des">
                ...
                <el-dropdown
                  ...
                  <el-dropdown-menu slot="dropdown" trigger="click">
                    ...
                    <el-dropdown-item :command="'3'">
                      <el-button type="text">文件</el-button>
                    </el-dropdown-item>
                    <el-dropdown-item :command="'5'">
                      <el-button type="text">海报</el-button>
                    </el-dropdown-item>
                  </el-dropdown-menu>
                </el-dropdown>
              </el-popover>
        ...
        <div
          ...
          <template v-if="talkList.length && moduleType === 2">
            ...
            <el-button type="primary" size="mini" v-loading="talkLoading" @click="tackSubmit">确定</el-button>
          </template>
          <template v-else-if="otherType !== 3 && moduleType !== 2">
            <el-button size="mini" @click="goBack" v-if="moduleType === 4">上一步</el-button>
            <el-button size="mini" @click="getCancel" v-if="moduleType !== 4">取消</el-button>
            <el-button type="primary" size="mini" v-loading="talkLoading" @click="tackSubmit">确定</el-button>
          </template>
          <template v-else-if="otherType === 3 && moduleType !== 2">
            <el-button size="mini" @click="goBack">取消</el-button>
            <el-button type="primary" size="mini" v-loading="talkLoading" @click="tackSubmit">通知成员发表</el-button>
          </template>
        </div>
      </el-col>
