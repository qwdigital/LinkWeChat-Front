<template>
  <div>
    <el-form-item label="详细地址" prop="address">
      <el-autocomplete :disabled="isDetail" @change="setChange" v-model="form.address" style="width:500px;" popper-class="autoAddressClass" :fetch-suggestions="querySearchAsync" :trigger-on-focus="false" placeholder="详细地址" clearable @select="handleSelect">
  ...
  export default {
    ...
    methods: {
      ...
      initMap () {
        ...
        var point = new BMap.Point(this.form.addrPoint.lng || 117.2334414073489, this.form.addrPoint.lat || 31.826578293886)
