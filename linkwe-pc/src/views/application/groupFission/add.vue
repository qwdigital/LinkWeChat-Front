...
import SelectGroup from '@/components/SelectCustomerGroup.vue'
...
export default {
  ...
  methods: {
    ...
    setSelectData(data) {
      this.groupForm.fissionTarget = data.groupName
      this.groupForm.fissionTargetId = data.chatId
    },
  },
  computed: {
    arrayTarget() {
      ...
      >
        ...
        <el-form-item label="群活码" prop="fissionTargetId">
          ...
          <div v-if="groupForm.fissionTargetId" class="changePosterBody">
            ...
            <span class="changeUrl ml10" @click="dialogVisibleSelectGroupCode = true">修改</span>
          </div>
        </el-form-item>
      </el-form>
    </div>
