<template>
  <div>
    <el-row :gutter="20" type="flex" style="margin-top: 20px;">
        ...
        <div class="g-card">
          ...
          <template v-if="baseData.type == 0">
            <Step3Type1
              ...
              @previewText="getPreviewInfoText"
            ></Step3Type1>
          </template>
      ...
      <el-col style="width: 370px;" v-if="baseData.type == 0 || baseData.type == 1">
      ...
      <el-col style="width: 370px;" v-if="baseData.type == 2">
        <div class="g-card" style="height: 100%;">
          <template>
            <div class="info_title">朋友圈预览</div>
            <FriendsCircPreviewVue
              :value="preview.templateInfo"
              :poster="posterObj.materialUrl"
            ></FriendsCircPreviewVue>
          </template>
        </div>
      </el-col>
      <el-col style="width: 750px;" v-if="baseData.type == 3">
        <div class="g-card" style="height: 100%;">
          <template>
            <div class="info_title">消息预览</div>
