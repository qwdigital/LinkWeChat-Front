...
<template>
  <div class="task-edit-container">
    <div class="edit-model">
      ...
      <el-form :model="query" :rules="ruleForm" ref="ruleForm" label-width="120px" class="top-search" labelPosition="left">
        ...
        <el-form-item label="活动时间" prop="dateRange">
          <el-date-picker v-model="query.dateRange" type="datetimerange" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期" align="right" value-format="yyyy-MM-dd HH:mm:ss"></el-date-picker>
        </el-form-item>
      </el-form>
    </div>
    <div class="edit-model">
    ...
    <div class="edit-model">
      ...
      <el-form :model="groupForm" :rules="ruleForm" ref="fissTarget" label-width="120px" class="top-search" labelPosition="left">
        <el-form-item label="选择海报" prop="postersId">
          <el-button type="primary" class="ml10" plain icon="el-icon-plus" size="mini" @click="dialogVisibleSelectPoster = true" v-if="!groupForm.postersId">选择海报</el-button>
        ...
        <el-form-item label="添加员工" prop="fissionTargetId">
          <el-button type="primary" class="ml10" plain icon="el-icon-plus" size="mini" v-if="!groupForm.fissionTargetId" @click="dialogVisibleTargetStff = true">添加员工</el-button>
    ...
    <!-- 选择使用员工弹窗 -->
    <SelectUser key="2" :visible.sync="dialogVisibleSelectUser" title="选择成员" :isOnlyLeaf="false" :isSigleSelect="false" @success="selectedUser"></SelectUser>
    <!-- 选择标签弹窗 -->
    ...
    <TargetSelectUser key="1" :visible.sync="dialogVisibleTargetStff" title="选择成员" :isOnlyLeaf="true" :isSigleSelect="true" @success="tagetSelect">
    </TargetSelectUser>
  </div>
</template>
