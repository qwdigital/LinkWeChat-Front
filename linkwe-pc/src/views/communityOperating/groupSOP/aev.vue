<template>
  <div class="wrap" v-loading="loading">
            ...
            <el-tab-pane name="0">
              ...
              <div v-for="text in textMaterialList" :key="text.id" class="text-wrapper">
                ...
                <el-button
                  ...
                  class="remove-btn"
                  size="mini"
                  @click="removeTextMaterial(text)"></el-button>
              </div>
            </el-tab-pane>
            ...
            <el-tab-pane name="1">
              ...
              <div v-for="image in imageMaterialList" :key="image.id" class="image-wrapper">
                ...
                <el-button
                  ...
                  class="remove-btn"
                  size="mini"
                  @click="removeImageMaterial(image)"></el-button>
              </div>
    ...
    <div class="preview-wrap">
      <!-- 预览 -->
      <div class="tip">群SOP样式</div>

      <PhoneDialog :message="form.content || '请输入内容'" :imageList="imageList" :messageList="messageList">
    ...
    <SelectMaterial
      ...
      type="4"
      @success="(data) => submitSelectMaterial(data, 4)"></SelectMaterial>
    ...
    <SelectMaterial
      ...
      :visible.sync="dialogVisibleSelectMaterial"
      type="0"
      @success="(data) => submitSelectMaterial(data, 0)"></SelectMaterial>

    <!-- 选择客户群聊 -->
    <SelectCustomerGroup
      :visible.sync="dialogVisibleSelectCustomerGroup"
      @success="submitSelectCustomerGroup"
      :multiSelect="true"></SelectCustomerGroup>
  </div>
</template>
...
export default {
  ...
  created() {
    ...
    // this.$route.meta.title = (this.ruleId ? '编辑' : '新建') + '群SOP'
  ...
  methods: {
    ...
    submitSelectMaterial(data, type) {
      data.id && !this.form.materialIdList.includes(data.id) && this.form.materialIdList.push(data.id)
