...
<template>
  <div>
    ...
    <div class="mid-action">
      <div>
        <el-button type="primary" @click="goRoute()">
          新建任务
        </el-button>
      </div>
      <div>
        <el-button :disabled="multiSelect.length === 0" @click="handleBulkRemove" type="danger">
          批量删除
        </el-button>
      </div>
    </div>
    ...
    <el-table v-loading="loading" :data="list" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" align="center" width="180" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button size="mini" type="text" @click="handleRemove(scope.row.taskId)">删除</el-button>
          <el-button size="mini" type="text" @click="goRoute(scope.row.taskId)">编辑</el-button>
        </template>
      </el-table-column>
    </el-table>
