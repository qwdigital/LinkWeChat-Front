<template>
  <div>
    ...
    <div class="cp flex aic">
      ...
      ></el-image>
      <div class="icon-style" v-else-if="objRow.svgName">
        <svg-icon class="icon-style" :iconClass="objRow.svgName"></svg-icon>
      </div>
      <div class="ml10" :style="{ 'max-width': width }">
        ...
        >
          <p style="white-space: pre-line" v-html="objRow.digest" slot="content"></p>
