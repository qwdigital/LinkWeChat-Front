<template>
  <div class="search">
    <div class="item">
      <el-button-group>
        <el-button
          ...
          >今日</el-button
        >
        <el-button size="mini" @click="setType(1)" :type="active === 1 ? 'primary' : ''"
          >近一周</el-button
        >
        <el-button size="mini" @click="setType(2)" :type="active === 2 ? 'primary' : ''"
          >近一月</el-button
        >
        <el-button size="mini" @click="setType(3)" :type="active === 3 ? 'primary' : ''"
          >自定义</el-button
        >
      </el-button-group>
    </div>
    ...
    <!-- <div class="item" v-if="showScene">
      ...
      <el-select :popper-append-to-body="false" size="mini" @change="submit()" v-model="data.scenes" clearable placeholder="请选择场景">
    ...
    <div class="item" v-if="showMember">
      <el-select :popper-append-to-body="false" size="mini" v-model="data.openKfIds" @change="setMemeber" clearable placeholder="请选择客服">
    ...
    <div class="item" v-if="showMember">
      <el-select :popper-append-to-body="false" size="mini" v-model="data.userIds" @change="selectMember" clearable placeholder="请选择接待员工">
