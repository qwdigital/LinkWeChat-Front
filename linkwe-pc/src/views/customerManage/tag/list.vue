...
<template>
  <div class="">
    <el-form :inline="true" label-width="0" label-position="left" class="top-search">
      <el-form-item label="">
        <el-input v-model="query.groupName" placeholder="请输入标签组名称" clearable @keyup.enter.native="getList(1)" />
      </el-form-item>
