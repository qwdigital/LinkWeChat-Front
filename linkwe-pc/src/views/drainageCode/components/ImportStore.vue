  ...
  <div>
    <el-dialog title="批量导入" :visible.sync="dialogVisible" width="500px">
      ...
      <div class="upload_content">
        <el-upload drag accept=".xls, .xlsx" :action="actionUrl" :limit="1" :headers="headers" ref="upload" :on-remove="handleRemove" :on-change="setFileData" :auto-upload="false">
      ...
      <div class="tip">
        ...
        <div>
          3、所属地区请务必按照“xxx省xxx市xxx区/县”格式填写。
        </div>
      </div>
