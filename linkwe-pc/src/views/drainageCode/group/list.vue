  ...
  <div>
    <div class="g-card g-pad20">
      ...
      <div class="mid-action">
        <div>
          <el-button type="primary" @click="$router.push('/drainageCode/qrCode/groupAdd')">新建活码</el-button>
        </div>
        <div>
      ...
      <el-table :data="groupCodes" v-loading="loading" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="活码客群数" align="center" width="120px" prop="chatGroupNum">
          ...
          <template #default="{ row }">
            <a style="color: #0079de; text-decoration: underline;" @click="getDetail(row.id)">{{ row.chatGroupNum }}</a>
          </template>
        </el-table-column>
