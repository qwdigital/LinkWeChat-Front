  ...
  <div class="flex" v-loading="loading">
    <el-form :model="form" ref="form" label-width="100px" class="g-card fxauto mr20">
      ...
      <el-form-item label="扫码标签" prop="weEmpleCodeTags">
        <!-- closable -->
        <el-tag size="medium" v-for="(item, index) in form.weEmpleCodeTags" :key="index">{{ item.tagName }}</el-tag>
        <el-button
          type="primary"
          class="ml10"
          plain
      ...
      <el-form-item label="欢迎语">
        <el-card shadow="never">
          ...
          <el-button v-else icon="el-icon-plus" size="mini" @click="dialogVisibleSelectMaterial = true">
            添加图片
          </el-button>
        </el-card>
        <el-button
    ...
    <div class="preview-wrap g-card mt0">
      ...
      <PhoneDialog :message="form.welcomeMsg || '请输入欢迎语'" :isOther="!!materialSelected">
        <el-image style="border-radius: 6px" :src="materialSelected" fit="fit"></el-image>
      </PhoneDialog>
