<template>
  <div>
    ...
    <div class="g-card">
      ...
      <el-table ref="myTable" v-loading="loading" :data="list" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
          <template slot-scope="{ row }">
            <el-button v-if="row.addState == 0" type="text" @click="tipFn(row.id)">提醒</el-button>
    ...
    <SelectWeUser
      ...
      title="选择员工"
      @success="selectedUserFn"></SelectWeUser>
    <!-- </div> -->
          ...
          <el-form-item label="选择表格" prop="file" required>
            <div style="display: flex">
              <el-upload
                ...
                :auto-upload="false">
                <el-button size="mini" type="primary" plain @click="clearData()">上传表格</el-button>
              </el-upload>
              <el-button style="margin-left: 10px; flex: 0" size="mini" type="text" plain @click="downloadFn">
                下载模板
              </el-button>
            </div>
          </el-form-item>
