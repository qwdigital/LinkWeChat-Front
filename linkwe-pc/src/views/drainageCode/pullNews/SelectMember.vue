    ...
    <div>
      ...
      <div class="select_unit" v-if="form.executeDeptCondit.change">
        <div v-if="selectedDeptList.length > 0">
          <el-tag size="medium" v-for="(item, index) in selectedDeptList" :key="index">{{
            item.deptName
          }}</el-tag>
        </div>
        <el-button
      ...
      <div class="select_unit" v-if="form.executeDeptCondit.change">
        <div v-if="selectedPostList.length > 0">
          <el-tag size="medium" v-for="(item, index) in selectedPostList" :key="index">{{
            item
          }}</el-tag>
        </div>
        <el-button
