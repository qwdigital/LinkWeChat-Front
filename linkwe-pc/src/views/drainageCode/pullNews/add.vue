    ...
    <div class="g-card">
      ...
      <div class="ar" style="margin-top: 30px">
        <template v-if="active === 0">
          ...
          <el-button type="primary" v-loading="loading" :disabled="loading" @click="infoNext"
            >下一步</el-button
          >
        </template>
...
export default {
  ...
  methods: {
    ...
    infoNext() {
      if (!this.$refs.baseInfo.handleValidateFn()) return
    ...
    getDetail(id) {
      getDetail(id).then((res) => {
        ...
        this.$set(this.query, 'qrUserInfos', list)
