<template>
  <div>
    ...
    <div class="g-card">
      <div class="fxbw">
        <el-button type="primary" @click="$router.push('/drainageCode/qrCode/pullNews/add')"
          >新建活码</el-button
        >
        <div>
          <!-- <el-button
      ...
      <el-table :data="groupCodes" v-loading="loading" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="操作" align="center" width="180" fixed="right">
          <template #default="{ row }">
            ...
            <el-button type="text" size="mini" @click="handleDownload(row.imageUrl, row.name)"
              >下载</el-button
            >
            <el-button type="text" size="mini" class="copy-btn" :data-clipboard-text="row.imageUrl"
              >复制</el-button
            >
