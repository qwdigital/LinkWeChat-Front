                  ...
                  <el-row>
                    <el-col :sm="24" :md="18">
                      ...
                      <el-form-item label="拉新方式:" class="pb20">
                        <div class="function">
                          <div class="function-item active-item">
                            ...
                            <!-- <svg-icon
                              class="icon-style"
                              :iconClass="functionList[form.type - 1].svg"
                            ></svg-icon> -->
                            <svg-icon class="icon-style" iconClass="redBox"></svg-icon>
                            <div>
                      ...
                      <el-form-item label="添加员工:" prop="chatIdList" class="pb20">
                        <template v-for="(item, index) in dealInfo(form.qrUserInfos)">
                          <el-tag :key="index" v-if="item">
                            {{ item }}
                          </el-tag>
                        </template>
                      </el-form-item>
                      <el-form-item label="添加标签:" class="pb20">
                        <template v-for="(item, index) in dealTag(form.qrTags)">
                      ...
                      <div class="redForm">
                        ...
                        <el-table
                          :data="dealTable(form.businessData)"
                          v-if="dealTable(form.businessData)"
                          class="mr10"
                        >
        ...
        <div class="g-card right-card-title">
          ...
          <div class="code-wrapper">
            ...
            <div class="code-actions">
              ...
              <el-button type="text" size="medium" @click="handleDownload(form.imageUrl, form.name)"
                >下载二维码</el-button
              >
              <!-- </a> -->
              <el-button id="copyUrl" type="text" size="medium" :data-clipboard-text="form.linkPath"
                >复制链接</el-button
              >
            </div>
          </div>
