  ...
  <div>
    ...
    <div class="g-card tab-content form3" v-if="currentActive == 3">
      <el-form style="margin-left: 30%; width: 500px">
        ...
        <el-form-item v-if="One == 1" style="padding-left: 120px" label="每人每天限制填写1次">
    ...
    <div class="g-card tab-content form4" v-show="currentActive === 4">
      <el-row>
        ...
        <el-col v-if="currentActive == 4" style="width: 35%">
  ...
  methods: {
    ...
    creatQrCode() {
      ...
      var qrcode = new QRCode(this.$refs.qrCodeUrl, {
        text: window.lwConfig.DOMAIN + '/#/formsDetail?id=q&formId=' + that.formId, // 需要转换为二维码的内容
        width: 150,
        height: 150,
        colorDark: '#000000',
        colorLight: '#ffffff',
