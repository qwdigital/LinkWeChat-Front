    ...
    <el-form ref="form" label-position="right" :model="form" :rules="rules" label-width="130px">
      <div class="g-card">
        ...
        <el-form-item label="企业logo" required prop="logoUrl">
          <upload-to-cos class="image-uploader" :fileUrl.sync="form.logoUrl" type="0"></upload-to-cos>
...
<script>
  import UploadToCos from '../../components/UploadToCos.vue'
  export default {
    components: { UploadToCos },
