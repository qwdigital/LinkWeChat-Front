        ...
        <el-form label-width="110px" label-position="right">
          <div class="g-card g-pad20">
            ...
            <el-form-item label="客户标签" v-if="form.scopeType === 0">
              <el-tag sizi="mini" v-for="(unit, key) in selectedTagList" :key="key">{{ unit.name }}
              </el-tag>
              <div>
            ...
            <el-form-item label="添加人" v-if="form.scopeType === 0">
              <el-tag sizi="mini" v-for="(unit, key) in selectedUserList" :key="key">{{ unit.name }}
              </el-tag>
              <div>
          ...
          <div class="g-card g-pad20" v-for="(item, index) in form.otherContent" :key="index">
            ...
            <div class="my-cord" v-else-if="item.annexType == 'link'">
              ...
              <el-form-item label="封面图片" style="width: 50%" required :error="item.otherError">
                <upload class="image-uploader" :fileUrl.sync="item.other" type="0"></upload>
              </el-form-item>
            </div>
          ...
          <!-- 添加附件 -->
          <div class="g-card g-pad20 add-continue" v-show="
