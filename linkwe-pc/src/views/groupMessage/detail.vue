    ...
    <el-row style="margin-top: 10px" type="flex" :gutter="10">
      <el-col :span="18">
        <div class="g-card">
          <div class="g-card-title fxbw">
            ...
            <div class="operation" v-if="isTask !== 1">
              ...
              <el-button class="ml10" type="primary" size="mini" @click="setFn">同步</el-button>
            </div>
          </div>
        ...
        <div class="g-card">
          ...
          <el-form :model="queryMember" ref="queryMemberForm" :inline="true" label-position="left" label-width="70px">
          ...
          <div>
            ...
            <pagination
              ...
              :total="member.total"
              :page.sync="queryMember.pageNum"
              :limit.sync="queryMember.pageSize"
        ...
        <div class="g-card">
          ...
          <el-form :model="queryCustomer" ref="queryForm" :inline="true" label-position="left" label-width="70px">
          ...
          <div>
            ...
            <pagination
              ...
              :page.sync="queryCustomer.pageNum"
              :limit.sync="queryCustomer.pageSize"
