<template>
  <div>
              ...
              <el-form ref="liveForm" :rules="liveRules" :model="liveForm" label-position="right" label-width="100px">
                ...
                <el-form-item
                  ...
                  <div v-if="users.length > 0">
                    <el-tag size="medium" v-for="(item, index) in users" :key="index">{{ item.name }}</el-tag>
                  </div>
                  ...
                  <div class="pickerStyle">
                    ...
                    <el-form-item prop="liveStartTime">
                      <el-time-select
                        ...
                        placeholder="选择时分"
                        @focus="liveStartTimeChange"></el-time-select>
                    </el-form-item>
                  </div>
                </el-form-item>
                  ...
                  <div class="pickerStyle">
                    ...
                    <el-form-item prop="liveEndTime">
                      <el-time-select
                        ...
                        placeholder="选择时分"
                        @focus="liveEndTimeChange"></el-time-select>
                    </el-form-item>
                  </div>
                </el-form-item>
                ...
                <el-form-item label="发送成员" required :error="userInfo">
                  ...
                  <el-form-item prop="sendWeUser" v-if="sendUser === 2">
                    <div v-if="sendUsers.length > 0">
                      <el-tag size="medium" v-for="(item, index) in sendUsers" :key="index">{{ item.name }}</el-tag>
                    </div>
                    <el-button type="primary" plain size="mini" @click="onSendSelectUser">
                ...
                <el-form-item label="发送客户" required :error="customerInfo">
                  ...
                  <el-form-item v-if="sendCustomer === 2">
                    <div v-if="sendCustomers.length > 0">
                      <el-tag size="medium" v-for="(item, index) in sendCustomers" :key="index">
                        {{ item.tagName }}
                      </el-tag>
                    </div>
                    <div>
                ...
                <el-form-item label="发送客户" required :error="groupInfo">
                  ...
                  <el-form-item v-if="sendCustomer === 2">
                    <div v-if="sendGroupCustomers.length > 0">
                      <el-tag size="medium" v-for="(item, index) in sendGroupCustomers" :key="index">
                        {{ item.name }}
                      </el-tag>
                    </div>
                    <div>
                      <el-button size="mini" type="primary" icon="el-icon-plus" @click="onGroupSelectUser">
    ...
    <SelectWeUser
      ...
      :defaultValues="selectedUserList"></SelectWeUser>
    <!-- 发送成员弹框 -->
    <SelectUser
      :defaultValues="sendSelectedUserList"
      :visible.sync="dialogVisibleSendSelectUser"
      title="选择发送成员"
      :isOnlyLeaf="false"
    ...
    <SelectUser
      :defaultValues="selectedTagList"
      :visible.sync="dialogVisibleSelectCustomers"
      title="选择发送群主"
