...
<template>
  <div>
    ...
    <el-table v-loading="loading" :data="list" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="发放员工" align="center" prop="userName" :show-overflow-tooltip="true"></el-table-column>
      ...
      <el-table-column label="领取详情" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          ...
          <el-button size="mini" type="text" @click="view(scope.row)">领取详情</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <!-- 选择使用员工弹窗 -->
    <SelectUser :visible.sync="dialogVisibleSelectUser" title="选择添加人" :defaultValues="queryUser" @success="
        (list) => {
          queryUser = list
    ...
    <el-dialog title="领取详情" :visible.sync="dialogVisible" width="width">
      <div>
        ...
        <pagination :total="dialog.total" :page.sync="dialog.query.pageNum" :limit.sync="dialog.query.pageSize" @pagination="getListGroupUser()" />
      </div>
      <div slot="footer">
