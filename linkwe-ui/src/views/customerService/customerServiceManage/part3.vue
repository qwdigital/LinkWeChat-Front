        ...
        <div class="g-card g-pad20">
            <el-form ref="form" :model="form" label-position="right" label-width="120px">
              ...
              <el-form-item label="接待上限:">
                一个接待员工最多同时接待<el-input-number v-model="form.receiveLimit" :min="2" :max="50" :controls="false"></el-input-number>人
                <div class="sub-des">
              ...
              <el-switch v-model="form.timeOutNotice" :active-value=1 :inactive-value=2></el-switch>
                ...
                超过 <el-input :disabled="form.timeOutNotice === 2" style=" width:60px;" :controls="false" v-model="form.timeOut"></el-input> <el-select :disabled="form.timeOutNotice === 2" style="width:80px;" v-model="form.timeOutType"> <el-option label="分钟" :value="1"></el-option><el-option label="小时" :value="2"></el-option> </el-select> 客户未回复时，自动发送提示语
              ...
              <el-switch v-model="form.endNotice" :active-value=1 :inactive-value=2></el-switch>
                ...
                超过 <el-input :disabled="form.endNotice === 2" style=" width:60px;" :controls="false" v-model="form.endNoticeTime"></el-input> <el-select :disabled="form.endNotice === 2" style="width:80px;" v-model="form.endTimeType"> <el-option label="分钟" :value="1"></el-option><el-option label="小时" :value="2"></el-option> </el-select> 客户未回复时，自动发送结束语
