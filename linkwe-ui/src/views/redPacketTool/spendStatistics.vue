	...
	<div>
		...
		<div class="g-card g-pad20">
			...
			<div class="chart-header">
				...
				<el-date-picker v-model="dateRange" size="small" class="ml20" style="width: 260px"
					value-format="yyyy-MM-dd" type="daterange" :clearable="false" range-separator="-"
					start-placeholder="开始日期" end-placeholder="结束日期" @change="getList"></el-date-picker>
			</div>
			<div>
		...
		<div class="g-card g-pad20">
			...
			<pagination :total="total" :page.sync="query.pageNum" :limit.sync="query.pageSize"
				@pagination="getList()" />
		</div>
	</div>
</template>
...
<script>
	...
	export default {
		...
		methods: {
			...
			setEchart() {
				setTimeout(() => {
					this.drawLine('chart', ['累计支出金额(元)', '今日支出笔数'], this.mockData[this.timeRange], ['#5AD2D2', '#637BC0'])
				}, 1000)
			},
