<template>
  <div>
        ...
        <el-form label-width="110px" label-position="right">
          <div class="g-card">
            <el-form-item label="使用员工" required :error="userError" v-if="showMember">
              ...
              <div>
                <el-button type="primary" plain @click="onSelectUser">选择员工</el-button>
              </div>
              <div class="sub-des">
            ...
            <div class="my-cord">
              <div v-if="showTemplate" class="operation" @click="getWelList(), (dialogVisibleSelectWel = true)">
                <el-icon-menu class="el-icon-menu mr5"></el-icon-menu>
                从模板库中选择
              </div>
    ...
    <SelectMaterial
      v-model:visible="dialogVisibleSelectMaterialWel"
      type="4"
