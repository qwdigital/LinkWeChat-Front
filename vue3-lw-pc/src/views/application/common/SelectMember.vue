  ...
  <div class="select_content">
    <div>
      ...
      <div class="select_unit" v-if="form.executeUserCondit.change">
        ...
        <el-button v-if="!isDetail" icon="el-icon-plus" type="primary" plain @click="dialogVisibleSelectUser = true">
    ...
    <div>
      ...
      <div class="select_unit" v-if="form.executeDeptCondit.change">
        ...
        <el-button v-if="!isDetail" icon="el-icon-plus" type="primary" plain @click="dialogVisibleSelectDept = true">
      ...
      <div class="select_unit" v-if="form.executeDeptCondit.change">
        ...
        <el-button v-if="!isDetail" icon="el-icon-plus" type="primary" plain @click="dialogVisibleSelectPost = true">
