   ...
   <el-table v-loading="loading" :data="list">
      ...
      <el-table-column label="操作" align="center" width="180" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button v-hasPermi="['enterpriseWechat:view']"  text @click="edit(scope.row, 0)"
            >查看</el-button
          >
          <el-button v-hasPermi="['enterpriseWechat:edit']"  text @click="edit(scope.row, 1)"
            >编辑</el-button
          >
          <el-button
    ...
    <!-- <el-dialog title="配置企业微信号"  v-model="dialogVisible">
       <div slot="footer">
