              ...
              <el-card>
                ...
                <template v-if="unit.swipType === 1">
                  <channel-label
                    ref="channel"
                    :currentData="unit"
                    :baseData="baseEnum.CorpAddStateEnum"></channel-label>
                </template>
                ...
                <template v-if="unit.swipType === 3">
                  <customer-attributes
                    ...
                    :relationData="baseEnum.RelationEnum"></customer-attributes>
                </template>
                <template v-if="unit.swipType === 4">
                  <customer-behavior
                    ...
                    :behaviorList="baseEnum.CustomerBehaviorEnum"></customer-behavior>
                </template>
                <template v-if="unit.swipType === 5">
                  <strategic-crowd
                    ref="crowd"
                    :currentData="unit"
                    :baseData="baseEnum.StrategicCrowdEnum"></strategic-crowd>
                </template>
              </el-card>
            </div>
          </template>
          <el-form>
            <el-form-item style="text-align: right">
              ...
              <el-button
                ...
                :disabled="submitLoading || !swipe.length">
                确定
              </el-button>
            </el-form-item>
          </el-form>
