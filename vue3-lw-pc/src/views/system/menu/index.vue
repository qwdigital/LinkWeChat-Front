    ...
    <div class="g-card">
      ...
      <el-table
        ...
        <el-table-column label="操作" align="center">
          <template #default="scope">
            <el-button text @click="handleUpdate(scope.row)" v-hasPermi="['system:menu:edit']">修改</el-button>
            <el-button text @click="handleAdd(scope.row)" v-hasPermi="['system:menu:add']">新增</el-button>
            <el-button text @click="handleDelete(scope.row)" v-hasPermi="['system:menu:remove']">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
    </div>
          ...
          <el-col :span="24">
            <el-form-item v-if="form.menuType != 'F'" label="菜单图标">
              <el-popover placement="bottom-start" width="460" trigger="click" @show="$refs['iconSelect'].reset()">
                ...
                <template #reference>
                  <el-select v-model="form.icon" remote placeholder="点击选择图标" clearable @clear="form.icon = '#'">
                    <template #prefix>
                      <svg-icon
                        v-if="form.icon"
                        :icon="form.icon"
